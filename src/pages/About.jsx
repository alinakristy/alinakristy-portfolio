                    ...
                    <div class="row my-3">
                        <div class="col-lg-6">
                            <ul>
                                ...
                                <li><i class="bi bi-chevron-right"></i> <strong>Linkedin 📱:</strong> <a href="https://www.linkedin.com/in/alina-cristi-osipov/">@alina-cristi-osipov</a></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Location 📍:</strong> <a href="https://maps.app.goo.gl/wXaY9Y1svtopTUVR6">Newcastle upon Tyne, UK</a></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Email ✉️:</strong> <a href="mailto:alina.cristi12@gmail.com">alina.cristi12@gmail.com</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <ul>
                                <li><i class="bi bi-chevron-right"></i> <strong>Degree 🏫:</strong> <span>Bachelor degree</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Freelance 🛠️:</strong> <span>Available ✅</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Work 💻:</strong> <span>Ready to start ASAP</span></li>
                                <li><i class="bi bi-chevron-right"></i> <strong>Work Type 🖥️:</strong> <span>Remote or On-Site</span></li>
                            </ul>
                        </div>
                    </div>
